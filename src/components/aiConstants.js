...
润色前先理解原文的意图——作者想让读者感受到什么？用更精准的方式达成同样的意图。
...
扩写不是把每句话都拉长，而是在有趣的地方展开，无聊的地方跳过。
...
6. 对话不是"信息交换"，是"试探边界"
7. 用"哦""嗯""呵呵"来代替完整回答
8. 允许对话"没用"——闲聊、废话让角色活了
9. 用沉默来代替回答。"不说话"比任何回答都有力量
10. 语气要不断转换，不要从头到尾一个调` },
