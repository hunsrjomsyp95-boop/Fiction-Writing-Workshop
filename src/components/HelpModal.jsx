...
const CHANGES = [
  {
    ...
    date: '2026-08-24',
    items: [
      'AI整理合并设定：世界观、人物、伏笔支持AI检测重复并合并',
      'AI自动配置人物关系：自动分析人物背景建立具体关系（父亲/母亲/师徒等）',
      'AI生成地图优化：根据设定内容智能匹配图标和颜色',
    ],
  },
  {
    ver: '1.3.7',
  ...
  },
  {
    ...
    date: '2026-08-22',
    items: [
      '新增5个内置提示词：章节开头钩子、章节结尾悬念、对话润色、反派设计、力量体系设计',
      'AI提示词全面增强：角色生成、世界观生成、单章正文等系统提示词从1行扩展为7-10条原则',
      '人物关系双向关系设定优化',
      '修复对话润色提示词语法错误',
    ],
  },
  {
    ...
    items: [
      ...
      '修复AI流式输出报错 res.body.getReader is not a function',
      '修复选区润色后替换位置错误和润色全文的问题',
    ],
  },
  {
    ver: '1.3.4',
    date: '2026-08-20',
    items: [
      '人物关系网双向箭头：双向关系显示两条平行线，分别标注正向和反向标签',
      '人物定位支持自定义：可添加自定义定位并保存',
      'AI提取合并改进：已存在实体不再重复创建，文本字段自动拼接合并',
      'AI代理配置：支持HTTP/SOCKS5代理',
