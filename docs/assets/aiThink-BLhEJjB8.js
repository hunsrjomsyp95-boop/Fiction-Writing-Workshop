import{c as l,g as p}from"./index-CZL6KbO1.js";import{U as u}from"./user-RgqO82o1.js";/**
...
请逐条列出问题，每条给出具体位置和改进建议。`,system:`你是资深小说编辑，专门识别和修改AI味文本。
...
2. 严格模仿样本的句式和用词
3. 保持原文的剧情走向
4. 避免AI味：不用"他感到、他意识到、不是...而是..."等表达`,system:`你是文风分析仿写专家。

核心原则：
1. 先提炼样本的句式、用词、描写、语气、节奏特点
2. 再严格模仿该风格进行改写/仿写
3. 避免AI味：不用"他感到、他意识到、不是...而是...、与其说...不如说..."等表达
4. 用动作呈现情绪，用口语化对话`}}case"beats":return{prompt:`请为当前章节设计情感节拍规划。
